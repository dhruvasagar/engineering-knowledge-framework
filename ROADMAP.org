...
- Rails Engineering: Complete capability with all 9 document types. Guides cover service objects, testing, audit, project standards, ActiveRecord, API development, background jobs, auth/authz. Playbooks cover upgrade and deployment. Checklists cover PR review, security review and deployment.

** Ready for Development

Handbook stubs exist for these capabilities:

- Security Engineering (=handbooks/security/=)
