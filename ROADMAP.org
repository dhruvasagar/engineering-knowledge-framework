...
- Rails Engineering: Handbook, glossary, guides (service objects, testing), playbook (upgrade), checklist (PR review), learning paths, references and AI workflows complete.
