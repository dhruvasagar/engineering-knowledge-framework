...
The project has completed **Phase 1** (Foundation) and **Phase 2**
(Foundation Capabilities). **Phase 3** (Engineering Capabilities) is in
progress:

- Rails Engineering: **Complete** (all 9 document types).
- Security Engineering: **Nearly complete** (missing templates).
- AI Engineering: **Partially complete** (missing playbooks, templates,
  AI workflows).
- Engineering Quality: **Partially complete** (missing playbooks,
  checklists, templates, AI workflows).
- Accessibility: **Not started** (all 9 document types to build).
...
[ ] **In Progress** — Rails Engineering is complete across all 9
    document types. Security, AI Engineering, and Engineering Quality
    have substantial content but are missing several document types.
    Accessibility has not been started. See the capability breakdown
    below for specific gaps.
...
*** [~] Security Engineering — 1 gap: templates

Present:

- [x] =handbooks/security/README.org=: Security Engineering Handbook.
- [x] =glossary/security/README.org=: Security terminology.
- [x] =guides/security/secure-coding.org=, =web-vulnerabilities.org=, =dependency-security.org= (3 guides + README).
...
- [ ] **Templates**: Security-specific templates (e.g., threat model template,
  security review report, security test plan). See the Rails templates
  (=templates/rails/=) for a reference pattern.

*** [~] AI Engineering — 3 gaps: playbooks, templates, AI workflows

Present:

- [x] =handbooks/ai/README.org=: AI Engineering Handbook.
- [x] =glossary/ai/README.org=: AI terminology.
- [x] =guides/ai/prompt-engineering.org=, =context-engineering.org=, =ai-safety.org= (3 guides).
...
- [ ] **Playbooks**: AI-assisted workflow playbooks (e.g., AI-assisted code
  review process, AI-assisted architecture review, AI pair programming
  workflow) at =playbooks/ai/=.
- [ ] **Templates**: AI-specific templates (e.g., context engineering template,
  prompt template, AI review response template) at =templates/ai/=.
- [ ] **AI Workflows**: Meta-AI workflows for the AI Engineering capability
  itself (how AI can assist with AI engineering tasks) at
  =prompts/ai-ai-workflows.org=.

*** [~] Engineering Quality — 4 gaps: playbooks, checklists, templates, AI workflows

Present:

- [x] =handbooks/quality/README.org=: Engineering Quality Handbook.
- [x] =glossary/quality/README.org=: Quality terminology.
- [x] =guides/quality/code-review-standards.org=, =quality-metrics.org=, =technical-debt-management.org= (3 guides).
- [x] =learning-paths/quality/README.org=: Three-tier learning path.
- [x] =references/quality/README.org=: Quick-reference material.

Missing:

- [ ] **Playbooks**: Quality workflow playbooks (e.g., quality review process,
  technical debt remediation workflow, release quality gate) at
  =playbooks/quality/=.
- [ ] **Checklists**: Quality-specific checklists (e.g., quality gate checklist,
  release readiness checklist, technical debt triage checklist) at
  =checklists/quality/=.
- [ ] **Templates**: Quality-specific templates (e.g., quality report template,
  technical debt register, quality metrics dashboard) at =templates/quality/=.
- [ ] **AI Workflows**: AI workflows for quality (e.g., quality review with AI,
  technical debt analysis with AI, test coverage assessment) at
  =prompts/quality-ai-workflows.org=.

*** [ ] Accessibility — not started (all 9 document types missing)

Empty stub directories exist at =handbooks/accessibility/= and
=glossary/accessibility/=. The entire capability needs to be built:

- [ ] **Handbook** (=handbooks/accessibility/README.org=): Accessibility Engineering
  Handbook covering principles (WCAG, inclusive design, assistive
  technology), standards, testing methodology and AI integration.
- [ ] **Glossary** (=glossary/accessibility/README.org=): Accessibility terminology
  (WCAG, ARIA, screen reader, keyboard navigation, colour contrast, etc.).
- [ ] **Guides** (=guides/accessibility/=): Multiple guides covering accessibility
  testing, semantic HTML, ARIA patterns, inclusive design, accessibility
  in CI/CD.
- [ ] **Playbooks** (=playbooks/accessibility-review/README.org=): Accessibility
  review workflow with evaluation criteria, tools and reporting.
- [ ] **Checklists** (=checklists/accessibility/=): Accessibility audit checklist,
  PR accessibility checklist, WCAG compliance checklist.
- [ ] **Templates** (=templates/accessibility/=): Accessibility report template,
  VPAT template, accessibility statement template.
- [ ] **Learning Paths** (=learning-paths/accessibility/README.org=): Three-tier
  learning path (beginner, intermediate, advanced).
- [ ] **References** (=references/accessibility/README.org=): Quick-reference
  material — WCAG levels, ARIA roles, testing tools, keyboard shortcuts.
- [ ] **AI Workflows** (=prompts/accessibility-ai-workflows.org=): AI workflows for
  accessibility auditing, remediation and testing.

See the Engineering Fundamentals capability as a template for structure
and conventions.
...
[ ] **Not Started** — No tooling has been built yet. This is the next
    ...
    The prompts directory ([[file:./prompts/README.org][index]]) and glossary/README provide
...
- [ ] Link validation: Verify all =[[file:...][...]]= cross-references resolve to existing files.
...
- [ ] Cross-reference extraction: Parse all documents and extract =[[file:...][...]]= links.
...
- [ ] =CONTRIBUTING.org=: Already published (see [[file:./CONTRIBUTING.org]]).
...
9. [ ] Complete Security Engineering capability (add templates).
10. [ ] Complete AI Engineering capability (add playbooks, templates, AI workflows).
11. [ ] Complete Engineering Quality capability (add playbooks, checklists, templates, AI workflows).
12. [ ] Build the Accessibility Engineering capability (all 9 document types).
13. [ ] Add practical exercises and assessments to learning paths (Phase 5).
14. [ ] Develop AI agentic workflows and evaluation frameworks (Phase 4).
15. [ ] Build initial validation tooling — link validation, style validation, glossary validation (Phase 6).
16. [ ] Build knowledge graph generation tooling (Phase 6).
