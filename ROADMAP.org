...
- Rails Engineering: Handbook, glossary, guides (service objects, testing, audit guide, project standards), playbook (upgrade), checklist (PR review), learning paths, references and AI workflows complete.
