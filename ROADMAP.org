...
- Rails Engineering: Handbook, glossary, guides (service objects, testing, audit guide), playbook (upgrade), checklist (PR review), learning paths, references and AI workflows complete.
