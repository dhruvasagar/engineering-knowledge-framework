...
content and custom widgets. Follow the [[file:../../references/accessibility/README.org][Accessibility References]] for
...
See [[file:../../prompts/accessibility-ai-workflows.org][AI Workflows for Accessibility]] for prompt patterns.
...
+---------------+----------------------------------------------+
| Handbook      | [[file:./README.org][Accessibility Engineering Handbook]]           |
| Glossary      | [[file:../../glossary/accessibility/README.org][Accessibility Glossary]]                      |
| Guides        | [[file:../../guides/accessibility/][Accessibility Guides]]                        |
| Playbooks     | [[file:../../playbooks/accessibility-review/README.org][Accessibility Review Playbook]]              |
| Checklists    | [[file:../../checklists/accessibility/][Accessibility Checklists]]                    |
| Templates     | [[file:../../templates/accessibility/][Accessibility Templates]]                     |
| Learning Paths| [[file:../../learning-paths/accessibility/README.org][Accessibility Learning Paths]]              |
| References    | [[file:../../references/accessibility/README.org][Accessibility References]]                   |
| AI Workflows  | [[file:../../prompts/accessibility-ai-workflows.org][AI Workflows for Accessibility]]            |
...
- [[file:https://www.w3.org/TR/WCAG22/][WCAG 2.2 Specification]]
- [[file:https://www.w3.org/WAI/ARIA/apg/][ARIA Authoring Practices Guide]]
