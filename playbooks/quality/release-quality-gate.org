...
- CI/CD pipeline configured with quality gates (see [[file:../../guides/rails/project-standards.org][Project Standards]]).
- Quality metrics baselines established (see [[file:../../guides/quality/quality-metrics.org][Quality Metrics]]).
- [[file:../../checklists/quality/release-readiness.org][Release Readiness Checklist]] available.
...
- Security vulnerability discovered: follow [[file:../../guides/security/dependency-security.org][Dependency Security]] response.
...
- [[file:../../checklists/rails/deployment.org][Rails Deployment Checklist]]
