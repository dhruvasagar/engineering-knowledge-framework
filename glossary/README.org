...
| Glossary       | Purpose                                 |
|----------------+-----------------------------------------|
| [[file:engineering/README.org][Engineering]]    | Repository-wide engineering terminology |
| [[file:architecture/README.org][Architecture]]   | Software architecture concepts          |
| [[file:rails/README.org][Rails]]          | Ruby on Rails terminology               |
| [[file:security/README.org][Security]]       | Security concepts and terminology       |
| [[file:accessibility/README.org][Accessibility]]  | Accessibility terminology               |
| [[file:testing/README.org][Testing]]        | Testing vocabulary                      |
| [[file:ai/README.org][AI Engineering]] | AI engineering terminology              |
