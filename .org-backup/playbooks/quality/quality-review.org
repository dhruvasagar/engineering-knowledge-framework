...
- Familiarity with [[file:../../guides/quality/quality-metrics.org][Quality Metrics]].
- Access to quality tooling (linters, static analysis, coverage reports).
- Understanding of [[file:../../handbooks/quality/README.org][quality principles]].
...
Evaluate against the standards in [[file:../../guides/quality/code-review-standards.org][Code Review Standards]] and
...
1. Document findings with severity labels (see [[file:../../references/quality/README.org][Quality References]]).
