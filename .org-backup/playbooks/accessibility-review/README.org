...
- Familiarity with [[file:../../handbooks/accessibility/README.org][Accessibility Engineering principles]].
- Accessibility testing tools installed (axe DevTools, colour contrast
  checker, screen reader).
- [[file:../../checklists/accessibility/][Accessibility checklists]] available.
...
1. Record all findings with severity labels (see [[file:../../references/accessibility/README.org][Accessibility References]]).
...
- [[file:../../checklists/accessibility/][Accessibility Checklists]]
